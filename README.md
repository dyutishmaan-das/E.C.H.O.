...
* **Team 1 (Embedded & AI)** will upload this dataset to Edge Impulse, train the C++ AI library, and write the complete ESP8266 AI Inference and Wi-Fi embedded firmware.
